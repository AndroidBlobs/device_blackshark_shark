...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_dvt2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_dvt2.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_factory.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_factory.xml \
...
# Keylayout
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/keylayout/fpcsensor.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/fpcsensor.kl \
...
# Inherit vendor
$(call inherit-product, vendor/blackshark/shark/shark-vendor.mk)